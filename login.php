		...
		<div class="wrapper">
			...
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					...
					<form id="1" name="1" class="login active">
						<h3>Login</h3>
						<div>
							<label>Username:</label>
							<input type="text"  name="username" id="username" />
						...
						<div class="bottom">
							...
							<a href="register.html" rel="register" class="linkform">You dont have an account yet? Register here</a>
							<div class="clear"></div>
						</div>
					</form>
					<form class="forgot_password">
						...
						<div class="bottom">
							...
							<a href="register.html" rel="register" class="linkform">You dont have an account? Register here</a>
							<div class="clear"></div>
						</div>
					</form>
				</div>
